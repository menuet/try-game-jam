...
// configuration step. It creates a namespace called `try-game-jam`. You can modify
...
int main(int argc, const char **argv)
{
 ...
 Options:
    ...
    std::map<std::string, docopt::value> args = docopt::docopt(USAGE,
      ...
      fmt::format("{} {}",
        try-game-jam::cmake::project_name,
        try-game-jam::cmake::project_version));// version string, acquired
